...
const TEACHER_FIELDS: Field[] = [
  ...
  { key: "experience", label: "Стаж преподавания", type: "text", hint: "например: 10 лет" },
  { key: "ages", label: "Возраст учеников", type: "text", hint: "например: 6–17 лет" },
  { key: "subjects", label: "Предметы", type: "list", hint: "можно добавить несколько" },
  { key: "achievements", label: "Достижения и опыт", type: "list" },
  { key: "extra", label: "Коротко", type: "list" },
  { key: "badges", label: "Баблы (доп. плашки)", type: "list", hint: "по одному на строку, порядок можно менять" },
